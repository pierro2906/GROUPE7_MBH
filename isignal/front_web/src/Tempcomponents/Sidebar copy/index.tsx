                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/"
                              className={({ isActive }) =>
                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-white dark:text-withe duration-300 ease-in-out dark:hover:text-primary hover:text-bodydark2 " +
                                (isActive &&
                                  "!text-bodydark2 dark:!text-primary")
                              }
                            >
                              eCommerce
                            </NavLink>
