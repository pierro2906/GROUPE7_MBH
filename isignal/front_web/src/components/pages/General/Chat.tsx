...
export function Chat(props: IAppProps) {
  return (
    <AuthLayout>
      <div className="flex flex-row h-full w-full overflow-x-hidden">
        <div className="flex flex-col py-8 pl-6 pr-2 w-64 flex-shrink-0">
          <div className="flex flex-row items-center justify-center h-12 w-full">
            <div className="flex items-center justify-center rounded-2xl text-primary bg-primary h-10 w-10">
              <svg
                className="w-6 h-6"
                fill="none"
                stroke="currentColor"
            ...
            <div className="ml-2 font-bold text-2xl">Quick Chat</div>
          </div>
          <div className="flex flex-col items-center bg-indigo-100   border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg">
            ...
            <div className="flex flex-row items-center mt-3">
              <div className="flex flex-col justify-center h-4 w-8 bg-primary rounded-full">
        ...
        <div className="flex flex-col flex-auto h-full p-6">
          <div className="flex flex-col flex-auto flex-shrink-0 rounded-2xl bg-gray-100 h-full p-4">
                ...
                <div className="grid grid-cols-12 gap-y-2">
                  ...
                  <div className="col-start-1 col-end-8 p-3 rounded-lg">
                    <div className="flex flex-row items-center">
                      ...
                      <div className="relative ml-3 text-sm  py-2 px-4 shadow rounded-xl">
                        <div className="flex flex-row items-center">
                          <button className="flex items-center justify-center bg-primary hover:bg-primary rounded-full h-8 w-10">
                            <svg
            ...
            <div className="flex flex-row items-center h-16 rounded-xl  w-full px-4">
              ...
              <div className="ml-4">
                <button className="flex items-center justify-center bg-primary hover:bg-primary rounded-xl text-white px-4 py-1 flex-shrink-0">
                  <span>Send</span>
                  <span className="ml-2">
                    <svg
